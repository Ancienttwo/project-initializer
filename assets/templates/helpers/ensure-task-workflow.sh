    ...
    cat > ".ai/harness/policy.json" <<'POLICY_EOF'
{
  ...
  "refactor": {
    ...
    "stages": {
      "scan": { "provider_version": "0.5.8", "required_features": ["module-statistics-v1", "refactor-assessment-v1", "recommendation-v3"] },
      "verify": { "provider_version": "0.5.8", "required_features": ["refactor-resolution-v1"] }
    },
    "workflow_routing": {
