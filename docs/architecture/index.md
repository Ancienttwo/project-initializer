...
flowchart LR
  ...
  subgraph RH["runtime-harness"]
    ...
    EngineerMessages(["engineer-messages<br/>closed message protocol 与 durable inbox"]):::harness
  ...
  EngineerMessages --> EngineerBindings
  McpSidecar --> EngineerMessages
  ...
  EvalsChecks -.->|gate| EngineerMessages
...
<!-- BEGIN ARCHCONTEXT:generated target="projection_target.architecture.index" sourceDigest="sha256:61de3aca76772cf813b7befd61ab664899323d88042997f5fd7c8fb0badea57a" rendererVersion="archcontext.docs-renderer/v4" outputDigest="sha256:2aaf8d426181a5d8bc11b51d018598e6151607326bc5d67af8db8da84de734eb" -->
# Architecture Index
