  ...
  "checks": [
    {
      "id": "canary1",
      "kind": "command",
      "command": "bun test --timeout 60000 tests/unit/issue-batch-reconcile.test.ts tests/effects/campaign-step.test.ts tests/effects/campaign-closeout.test.ts tests/unit/campaign-fresh-audit.test.ts tests/effects/campaign-fresh-audit.test.ts tests/cli/campaign-planning.test.ts",
      "cwd": ".",
      "phase": "verification",
      "cost": "normal",
