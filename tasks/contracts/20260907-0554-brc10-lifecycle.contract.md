...
```json
{
  ...
  "checks": [
    ...
    },
    {
      ...
      "cost": "normal",
      "evidence_policy": "current_exact",
      "necessity": "Real-process invocation, two-process election and crash/rebind matrix.",
      "inputs": {
        "env": []
      }
    },
    {
      ...
      "cost": "normal",
      "evidence_policy": "current_exact",
      "necessity": "Existing campaign admission/renewal, provider parser, runner and Lease boundaries.",
      "inputs": {
        "env": []
      }
    },
...
- Functional behavior: BRC10 remains open until the complete provider/fence/reclaim/rebind matrix passes.
