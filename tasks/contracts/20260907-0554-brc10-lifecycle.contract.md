...
- Source plan: `plans/plan-20260907-0554-brc10-lifecycle.md`
...
allowed_paths:
  ...
  - tasks/contracts/20260907-0554-brc10-lifecycle.contract.md
  - tasks/reviews/20260907-0554-brc10-lifecycle.review.md
  - tasks/notes/20260907-0554-brc10-lifecycle.notes.md
...
```json
{
  ...
  "checks": [
    ...
    },
    {
      ...
      "necessity": "Real-process invocation, two-process election and crash/rebind matrix. Baseline at 16aaf754; subsequent product delta only rejects unknown top-level provider events, covered by the named current parser and typed-process checks.",
      "inputs": {
        "env": []
      },
      "baseline": {
    ...
    },
    {
      ...
      "cost": "normal",
      "evidence_policy": "baseline_with_delta",
      "necessity": "Existing campaign admission/renewal, provider parser, runner and Lease boundaries. Baseline at 16aaf754; subsequent product delta only rejects unknown top-level provider events, covered by the named current parser and typed-process checks.",
      "inputs": {
        "env": []
      },
      "baseline": {
    ...
    },
    {
      ...
      "kind": "command",
      "command": "bun test tests/effects/brc10-lifecycle.test.ts --test-name-pattern 'typed' --timeout 60000",
      "cwd": ".",
      "phase": "verification",
      "cost": "normal",
      "evidence_policy": "current_exact",
      "necessity": "Typed process invocation and terminal recovery after parser-only delta.",
      "inputs": {
        "env": []
      }
    }
