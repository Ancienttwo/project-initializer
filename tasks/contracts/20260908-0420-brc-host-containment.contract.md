...
> **Status**: Active
> **Plan**: plans/plan-20260908-0420-brc-host-containment.md
> **Task Profile**: code-change
> <!-- legal values: code-change | docs-only | ledger-closeout | migration | eval-only | delegated-run | bugfix (omit for legacy passthrough); see docs/reference-configs/sprint-contracts.md -->
> **Owner**: ancienttwo
> **Capability ID**: root
> **Last Updated**: 2026-09-08 05:38
> **Review File**: `tasks/reviews/20260908-0420-brc-host-containment.review.md`
> **Notes File**: `tasks/notes/20260908-0420-brc-host-containment.notes.md`
...
- Source plan: `plans/plan-20260908-0420-brc-host-containment.md`
...
allowed_paths:
  ...
  - plans/plan-20260908-0420-brc-host-containment.md
  - tasks/todos.md
  - tasks/contracts/20260908-0420-brc-host-containment.contract.md
  - tasks/notes/20260908-0420-brc-host-containment.notes.md
  - tasks/reviews/20260908-0420-brc-host-containment.review.md
```
