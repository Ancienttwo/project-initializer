> **Archived**: 2026-09-07 14:28
> **Related Plan**: plans/archive/plan-20260907-1224-brc13-closeout.md
> **Outcome**: Completed
> **Lifecycle**: plan
> **Parent Run ID**: run-20260907-1428
> **Archive Projection V1**: `plans/plan-20260907-1224-brc13-closeout.md` => `plans/archive/plan-20260907-1224-brc13-closeout.md`
> **Archive Projection V1**: `tasks/notes/20260907-1224-brc13-closeout.notes.md` => `tasks/archive/notes-20260907-1428-brc13-closeout.md`
> **Archive Projection V1**: `tasks/contracts/20260907-1224-brc13-closeout.contract.md` => `tasks/archive/contract-20260907-1428-brc13-closeout.md`
> **Archive Projection V1**: `tasks/reviews/20260907-1224-brc13-closeout.review.md` => `tasks/archive/review-20260907-1428-brc13-closeout.md`
...
> **Verification Boundary**: Commands named in the captured planning output plus `repo-harness run verify-contract --contract tasks/archive/contract-20260907-1428-brc13-closeout.md --strict`.
...
> **Task Contract**: `tasks/archive/contract-20260907-1428-brc13-closeout.md`
> **Task Review**: `tasks/archive/review-20260907-1428-brc13-closeout.md`
> **Implementation Notes**: `tasks/archive/notes-20260907-1428-brc13-closeout.md`
...
- Sprint contract: `tasks/archive/contract-20260907-1428-brc13-closeout.md`
- Sprint review: `tasks/archive/review-20260907-1428-brc13-closeout.md`
- Implementation notes: `tasks/archive/notes-20260907-1428-brc13-closeout.md`
- Deferred-goal ledger: `tasks/todos.md`
- Current checks: `.ai/harness/checks/latest.json`
- Run snapshots: `.ai/harness/runs/`
- Scope authority: `tasks/archive/contract-20260907-1428-brc13-closeout.md` `allowed_paths`
...
## Task Contracts
- Contract file: `tasks/archive/contract-20260907-1428-brc13-closeout.md`
- Review file: `tasks/archive/review-20260907-1428-brc13-closeout.md`
- Implementation notes file: `tasks/archive/notes-20260907-1428-brc13-closeout.md`
- Template: `.claude/templates/contract.template.md`
- Verification command: `repo-harness run verify-contract --contract tasks/archive/contract-20260907-1428-brc13-closeout.md --strict`
...
- **Rollback surface**: Before execution remove `plans/archive/plan-20260907-1224-brc13-closeout.md`; after execution revert branch `codex/brc13-closeout` or the explicitly reviewed diff.
- **Verification boundary**: Commands named in the captured planning output plus `repo-harness run verify-contract --contract tasks/archive/contract-20260907-1428-brc13-closeout.md --strict`.
- **Review/acceptance boundary**: `tasks/archive/review-20260907-1428-brc13-closeout.md` must record pass against the captured acceptance criteria.
- **High-risk surface**: Risks named in captured planning output; keep the plan Draft if risk ownership is not concrete.
- **Why not checklist row**: risk_boundary

## Evidence Contract

- **State/progress path**: `plans/archive/plan-20260907-1224-brc13-closeout.md` task breakdown, `tasks/todos.md` deferred-goal ledger, `tasks/archive/contract-20260907-1428-brc13-closeout.md`, `tasks/archive/review-20260907-1428-brc13-closeout.md`, and `tasks/archive/notes-20260907-1428-brc13-closeout.md`
- **Verification evidence**: `.ai/harness/checks/latest.json`, `.ai/harness/runs/`, and the commands named in the captured planning output
- **Evaluator rubric**: `tasks/archive/review-20260907-1428-brc13-closeout.md` must record a passing Waza /check style recommendation
