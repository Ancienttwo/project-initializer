...
function setupManagedRuntimeReadback(home: string, fakeBin: string, harnessVersion = '9.9.9'): void {
  ...
  writeFileSync(join(harness, 'package.json'), JSON.stringify({
    ...
    dependencies: { archctx: '0.5.9', 'archctx-contracts': '0.5.9' },
  }));
  ...
  writeFileSync(join(globalModules, 'archctx-contracts', 'package.json'), JSON.stringify({ name: 'archctx-contracts', version: '0.5.9' }));
