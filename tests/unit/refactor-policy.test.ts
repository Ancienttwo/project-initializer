...
const expected = (mode: "off" | "shadow" | "active" = "off", require_cutover_closure = false) => ({
  ...
  stages: {
    scan: { provider_version: "0.5.9" as const, required_features: ["module-statistics-v1", "refactor-assessment-v1", "recommendation-v3"] },
    verify: { provider_version: "0.5.9" as const, required_features: ["refactor-resolution-v1"] },
  },
