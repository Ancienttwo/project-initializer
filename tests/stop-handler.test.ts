...
describe('runStopHandler', () => {
  test('surfaces projection retry advisory and blocks only under the independent projection failure gate', () => {
    ...
    writeFileSync(join(strictRoot, '.ai/harness/policy.json'), '{"architecture":{"projection_provider":"archctx","projection_apply":"automatic","projection_version":"0.5.9","projection_failure_gate":"strict"}}\n');
    ...
    writeFileSync(join(invalidGateRoot, '.ai/harness/policy.json'), '{"architecture":{"projection_provider":"archctx","projection_apply":"automatic","projection_version":"0.5.9","projection_failure_gate":"block"}}\n');
